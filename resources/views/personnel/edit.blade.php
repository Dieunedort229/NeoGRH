    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Modifier Personnel') }} - {{ $personnel->nom_complet }}
            </h2>
                    ...
                    <form action="{{ route('personnel.update', $personnel) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nom" id="nom" value="{{ old('nom', $personnel->nom) }}" 
                            ...
                            <div>
                                ...
                                <input type="text" name="prenom" id="prenom" value="{{ old('prenom', $personnel->prenom) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            ...
                            <div>
                                ...
                                <input type="text" name="matricule" id="matricule" value="{{ old('matricule', $personnel->matricule) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email', $personnel->email) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            ...
                            <div>
                                ...
                                <input type="text" name="telephone" id="telephone" value="{{ old('telephone', $personnel->telephone) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            ...
                            <div>
                                ...
                                <input type="date" name="date_naissance" id="date_naissance" value="{{ old('date_naissance', $personnel->date_naissance?->format('Y-m-d')) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea name="adresse" id="adresse" rows="3" 
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('adresse', $personnel->adresse) }}</textarea>
                            ...
                            <div>
                                ...
                                <input type="text" name="poste" id="poste" value="{{ old('poste', $personnel->poste) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            ...
                            <div>
                                ...
                                <input type="text" name="departement" id="departement" value="{{ old('departement', $personnel->departement) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            ...
                            <div>
                                ...
                                <input type="date" name="date_embauche" id="date_embauche" value="{{ old('date_embauche', $personnel->date_embauche?->format('Y-m-d')) }}" 
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            ...
                            <div>
                                ...
                                <input type="number" name="salaire" id="salaire" value="{{ old('salaire', $personnel->salaire) }}" step="0.01" min="0"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                            ...
                            <div>
                                ...
                                <input type="text" name="numero_cnss" id="numero_cnss" value="{{ old('numero_cnss', $personnel->numero_cnss) }}" 
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea name="notes" id="notes" rows="3" 
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('notes', $personnel->notes) }}</textarea>
